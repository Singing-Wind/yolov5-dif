...
def parse_opt(known=False):
    ...
    #whu-ft
    opt.data = 'data/Google-CD9.yaml' #'data/Google-CD.yaml' #'data/LEVIR-CD.yaml' #'data/whu-diff3.yaml' #'data/WHU-hull_ft-dif.yaml'
    #whu
    ...
    opt.epochs = 200
    opt.device = 'cuda:2'
    #opt.resume = 'runs/train/exp/weights/last.pt'
