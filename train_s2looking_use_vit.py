...
def parse_opt(known=False):
    ...
    #whu-ft
    opt.data = 'data/s2looking4-sim.yaml' #'data/Google-CD.yaml' #'data/LEVIR-CD.yaml' #'data/whu-diff3.yaml' #'data/WHU-hull_ft-dif.yaml'
    #whu
    # opt.data = 'data/whu-diff.yaml'

    # opt.cfg = 'models/yolov11s-dif-VitA23.yaml'
    opt.cfg = 'models/yolov11s-dif-HA23-first-match.yaml' #'models/yolov11s-dif-HA23.yaml'
